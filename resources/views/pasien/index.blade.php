                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->alamat }}</td>
                                <td nowrap>
                                    <a href="/pasien/edit/{{ $item->id }}" class="btn btn-warning btn-sm">
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                    <form action="/pasien/delete/{{ $item->id }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                ...
                <form action="{{ url('/pasien/store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="wa" class="form-control" placeholder="Masukkan nomor WA diawali dengan 62" pattern="62[0-9]{9,}" required>
                        </div>
                    </div>
                    <div class="form-row mt-3">
                        <div class="col-12">
