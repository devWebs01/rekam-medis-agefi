...
<style>
    body {
        background-color: #f8f9fa; /* Ensure body background is not interfering */
    }
    .login-background {
        background-image: url('https://images.unsplash.com/photo-1585320806297-9794b3e4b8d6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80'); /* Dental Clinic Image */
    ...
    #log {
        ...
        max-width: 900px; /* Example: make container slightly wider */
    }
    .card {
