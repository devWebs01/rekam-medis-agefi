                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td nowrap>
                                    ...
                                    <a href="/tarif/delete/{{ $item->id }}" class="btn btn-danger btn-sm"
                ...
                <form action="{{ url('/tarif/store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row mt-3">
                        <div class="col-md-12">
                            ...
                            <input type="number" name="nominal" min="1000" class="form-control" placeholder="Masukkan Nominal Tarif" required>
                        </div>
                    </div>
