...
Route::group(['middleware' => ['auth', 'HakRole:Dev,User']], function () {
    Route::group(['prefix' => 'pasien'], function () {
        ...
        Route::get('/delete/{id}', [App\Http\Controllers\PasienController::class, 'delete']);
    });
    Route::group(['prefix' => 'dokter'], function () {
        ...
        Route::get('/delete/{id}', [App\Http\Controllers\DokterController::class, 'delete']);
    });
    ...
    Route::group(['prefix' => 'tarif'], function () {
        ...
        Route::get('/delete/{id}', [App\Http\Controllers\TarifController::class, 'delete']);
    });
